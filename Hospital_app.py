...
DEPT_INFO = {
  ...
  "Cardiology":{
    ...
    'next':['Visit Level 3, Wing A','Estimated wait: 20-30 min', 'Bring any previous ESG reports']
  },
    "Gastroenterology": {
  ...
  "Neurology":{
    ...
    'next':['Visit Level 4, Wing A','Estimated wait: 25-35 min', 'Bring list of current medication']
  },
  "General Medicine":{
  ...
  "Dermatology":{
    ...
    'next':['Visit Level 2, Wing D','Estimated wait: 15-20 min', 'Bring Photos of affected areas if possible']
  },
}
